...
namespace MinecraftCrafterList.Miscellaneous
{
    class ColourSets
    {
        ...
        public static Color whiteTextShadow = Color.FromRgb(63, 61, 62);
        ...
        public static Color blueTextShadow = Color.FromRgb(18, 24, 58);
        ...
        //public static SolidColorBrush whiteTextShadow = new SolidColorBrush(Color.FromRgb(63, 61, 62));
        //public static SolidColorBrush BlueTextShadow = new SolidColorBrush(Color.FromRgb(18, 24, 58));

        //Item Button Border Colours
